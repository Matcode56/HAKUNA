        ...
        <>
          <div className="flex justify-end -mt-10 mb-6">
            <Select
              ...
              placeholder="Sort By"
              onChange={(option) => {
                if (option) setSortProperty(option.value);
              }}
              styles={selectStyle}
            />

            <button className="bg-lavender text-white px-5 py-1 rounded-xl drop-shadow-md">
              Filters{" "}
            </button>
          </div>
              ...
              (project: {
                ...
                >
                  <button
                    ...
                    onClick={() => {
                      document
                        .querySelector(".modal-single-project")
                  ...
                  <button
                    ...
                    onClick={() => {
                      document
                        .querySelector(".modal-update-project")!
                        .classList.add("is-active");
                      projectDispatch({
                        type: "GET_ID",
                        payload: data.getProjects,
                  ...
                  <button
                    ...
                    onClick={() =>
                      document
                        .querySelector(
                          `button[data-id='${project.id}'] ~ .modal-delete`
                        )
                  ...
                  <div className="modal-delete">
                    ...
                    <div className="flex justify-around">
                      <button
                        ...
                        onClick={() =>
                          deleteProject({
                            variables: { deleteProjectId: project.id },
                          })
                        }
                      >
                        Yes
