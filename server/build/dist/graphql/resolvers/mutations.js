...
exports.Mutation = {
    ...
    createUser: (parent, args) => __awaiter(void 0, void 0, void 0, function* () {
        const password = yield cryptagePassword(args.password);
        function cryptagePassword(password) {
            return __awaiter(this, void 0, void 0, function* () {
                const salt = yield bcrypt.genSalt();
                const passwordHashed = yield bcrypt.hash(password, salt);
    ...
    updateUser: (parent, args, decodedToken) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const user = yield database_1.prisma.users.findUnique({ where: { id: Number(args.id) } });
        if (!user)
            throw new Error('id invalid');
        const email = args.email ? yield checkEmail(args.email) : user.email;
        ...
        function checkEmail(emailToCheck) {
            return __awaiter(this, void 0, void 0, function* () {
                const email = yield database_1.prisma.users.findUnique({ where: { email: emailToCheck } });
                if (email)
    ...
    login: (parent, args) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            const user = yield database_1.prisma.users.findUnique({ where: { email: args.email } });
            if (!user)
                throw new Error('No user with that email');
            const isValidPassword = yield bcrypt.compare(args.password, user.password);
            if (!isValidPassword)
